...
const getAllRestaurants = (state = {},action) =>{
    ...
    switch(action.type){
        ...
        case REST_SEARCH_BY_LOC_REQUEST:
                return({loading:false,allRestaurants:action.payload})
